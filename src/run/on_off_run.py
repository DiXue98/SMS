...
def run_sequential(args, logger):
    ...
    args.pre_transition_items = ["state", "avail_actions", "obs"]
    args.post_transition_items = ["reward", "terminated"]
    if args.env == "listener_speaker":
        scheme.update({"msg": {"vshape": (2*env_info["n_agents"],), "group": "agents"}})
        args.pre_transition_items.append("msg")
    groups = {
